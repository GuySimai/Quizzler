...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        v_button = Button(image=v_img, highlightthickness=0, command=self.true_pressed)
        v_button.grid(row=2, column=0)

        x_img = PhotoImage(file="images/false.png")
        x_button = Button(image=x_img, highlightthickness=0, command=self.false__pressed)
